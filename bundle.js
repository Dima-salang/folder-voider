...
MdFilledButton.styles = [styles$h, styles$i, styles$j];
...
MdOutlinedButton.styles = [styles$h, styles$g];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$8 = i$4 `@media(forced-colors: active){.menu{border-style:solid;border-color:CanvasText;border-width:1px}}/*# sourceMappingURL=forced-colors-styles.css.map */
`;
...
MdMenu.styles = [styles$7, styles$8];
MdMenu = __decorate([
    e$9('md-menu')
], MdMenu);
...
MdOutlinedSelect.styles = [styles$5, styles$6, styles$9];
...
MdSelectOption.styles = [styles$3, styles$4];
...
MdElevatedButton.styles = [styles$h, styles$i, styles];
